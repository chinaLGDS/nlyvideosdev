...
@Configuration
@EnableSwagger2
//访问网址 http://localhost:8083/swagger-ui.html
...
//         .globalOperationParameters(pars)
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.nly.Controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 设置联系人
                .contact(new Contact("nly-小坤", "http://www.imooc.com", "imooc@163.com"))
                // 描述
